...
diff --git a/ai_mediation_all_in_one.py b/ai_mediation_all_in_one.py
index f4a29881fa4801888906d35cb53ec3463e8faa76..5e13c7b3ec354db9f80128fb5ac7ec77e67b42ad 100644
--- a/ai_mediation_all_in_one.py
+++ b/ai_mediation_all_in_one.py
@@ -1,128 +1,145 @@
 # -*- coding: utf-8 -*-
 def logprint(text):
     print(text)

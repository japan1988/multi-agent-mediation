...
documents unless separate document-generation libraries are connected and
tested.
...
path = Path("/mnt/data/README_adopted_with_dradm_artifacts.md")
...
採用してよいです。
下が tasukeru_dradm_draft.md / .json まで反映した README.md フル版です。

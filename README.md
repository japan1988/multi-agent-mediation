...
+    <img src="https://github.com/japan1988/multi-agent-mediation/actions/workflows/ci.yml/badge.svg?branch=main" alt="CI Status">
   </a>
   <br/>
...
+
 ...
 Maestro Orchestrator is a **research-oriented orchestration framework** for supervising **multiple executors** (e.g., routes, tools, LLM methods) with **fail-closed** safety.
